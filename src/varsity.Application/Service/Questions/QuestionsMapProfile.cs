    ...
    public class QuestionMapProfile : Profile
    {
        public QuestionMapProfile()
        {
            CreateMap<Question, QuestionDto>()
                  ...
                  .ForMember(p => p.PersonId, m => m.MapFrom(p => p.Person != null ? p.Person.Id : (Guid?)null))
                  .ForMember(p => p.PersonName, m => m.MapFrom(p => p.Person != null ? p.Person.Surname : null))
                  .ForMember(e => e.ModuleId, m => m.MapFrom(e => e.Module != null ? e.Module.Id : (Guid?)null))
                  .ForMember(e => e.ModuleName, m => m.MapFrom(e => e.Module != null ? e.Module.Name : null));
