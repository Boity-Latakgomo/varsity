...
{
    public abstract class varsityWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static varsityWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(varsityWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<varsityDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<varsityDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<varsityDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<varsityDbContext, Task<T>> func)
        {
            T result;
